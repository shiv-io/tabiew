...
const KEYBINDINGS: &[(&str, &str, &str)] = &[
    ...
    ("Global", "q", "Close the view, or quit on the last tab"),
    ("Global", "t", "Open the tab switcher"),
    ("Global", "Shift+H / Shift+Left", "Go to the previous tab"),
    ...
    ("Table", "1 - 9", "Go to a row number starting with it"),
    ...
    ("Sheet", "f", "Switch the plain and JSON format"),
    ("Sheet", "c", "Copy the row to the clipboard"),
    ("Sheet", "q / Esc", "Close the sheet"),
    ("Tabs", "j / Down / Ctrl+n", "Select the next tab"),
    ("Tabs", "k / Up / Ctrl+p", "Select the previous tab"),
    ("Tabs", "g / Home", "Select the first tab"),
    ("Tabs", "G / End", "Select the last tab"),
    ("Tabs", "Backspace / Delete", "Close the selected tab"),
    ("Tabs", "Enter", "Go to the selected tab"),
    ("Tabs", "q / Esc", "Close the tab switcher"),
    ...
    ("Schema", "Enter", "Open the selected table in a tab"),
